...
> [!question] Diferencia entre la Ing. en Sistemas e Ing. en Software
...
- **Noticia:** Resulta de la carga de significado(sentido, contexto y utilidad) puesta en el dato. Es cuando le damos sentido al dato. Tiene que ser:
	- a. Desconocido
	- b. Relevante
	- c. Entendido

- **Conocimiento:** Es el proceso activo e interno de cada individuo donde se comprende la noticia. (Se compara con otra y se generan enlaces relevantes)
...
**Producto Solución:** Conjunto de componentes (Software, hardware y servicios externos) diseñado para satisfacer necesidades de un cliente u organización.

**Producto Software:** Sistema de informático desarrollado para comercializarse o distribuirse como herramienta. 

> Un producto solución puede tener o no sistema informático.
